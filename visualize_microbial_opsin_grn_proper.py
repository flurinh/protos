...
This script follows Protos data management principles:
1. Uses processors for all data operations
2. No direct file path manipulation
3. Leverages the existing assign_grns method
"""
...
def main():
    ...
    # Initialize paths and processor - let Protos handle everything
    paths = ProtosPaths()
    struct_proc = StructureProcessor(name="mo_viz", paths=paths)
    
    # Load structure
    print("Microbial Opsin GRN Visualization")
    print("="*60)
    print("\nLoading microbial opsin structure...")
    
    # Try to load common microbial opsin structures
    pdb_ids = ["1UAZ", "6RMK", "1M0L", "3UG9", "4HYJ", "4PXK"]
    ...
    # Use the built-in assign_grns method - it handles everything internally
    ...
    print("- mo_helix_wheel.html")
    print("- mo_snake_plot.html")
    print("- mo_3d_structure.html")
    print("- mo_3d_interactive_slider.html")
    print("- mo_grn_heatmap.html")
