...
This module tests the path handling functionality of the BaseProcessor
...
# Skip tests if path module is not available
...
class TestProcessor(BaseProcessor):
    ...
    def _get_default_data_dir(self) -> str:
        """Override to return consistent directory name for tests."""
