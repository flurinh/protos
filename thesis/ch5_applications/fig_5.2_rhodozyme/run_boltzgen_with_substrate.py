#!/usr/bin/env python3
"""Run BoltzGen on the 3 refined catalytic triad placements WITH substrate."""
...
CONFIG_DIR = OUTPUT_DIR / "boltzgen_configs_with_substrate"
DATA_ROOT = REPO_ROOT / "data"


def main() -> int:
    print("=" * 70)
    print("RUNNING BOLTZGEN ON REFINED PLACEMENTS WITH SUBSTRATE")
    print("=" * 70)
