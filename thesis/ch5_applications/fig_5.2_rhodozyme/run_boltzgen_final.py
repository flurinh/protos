#!/usr/bin/env python3
"""Run BoltzGen with final corrected configs."""
...
def main() -> int:
    print("=" * 70)
    print("RUNNING BOLTZGEN WITH FINAL CORRECTED CONFIGS")
    print("=" * 70)
    print("\nKey corrections:")
    print("  - No duplicate ligands (retinal is in structure)")
    print("  - Substrate (chain B) as fixed structural constraint")
    print("  - Contiguous residue numbering")
    print("  - Proper BoltzGen YAML syntax")
    ...
    for i, config_path in enumerate(config_files):
        ...
        # Add num_designs (protos wrapper param)
        config["num_designs"] = 8
    ...
    # Save results
    results_path = OUTPUT_DIR / "boltzgen_final_results.json"
