...
def sample_sequences() -> Dict[str, str]:
    """Sample sequences for FASTA old_tests."""
    return {
        "seq1": "ACGTACGTACGT",
        "seq2": "TGCATGCATGCA",
...
def sample_grn_table() -> pd.DataFrame:
    """Sample GRN table for old_tests."""
    data = {
        "3.50": ["M125", "M123", "M127"],
        "6.48": ["Y261", "Y259", "Y263"],
        "7.49": ["P296", "P294", "P298"]
...
def sample_property_table() -> pd.DataFrame:
    """Sample property table for old_tests."""
    data = {
...
def sample_embeddings() -> Dict[str, np.ndarray]:
    """Sample embeddings for old_tests."""
    return {
...
# Temporary file management old_tests
...
# External tool helper old_tests
