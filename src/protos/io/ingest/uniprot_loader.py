from protos.io.formats.fasta_utils import validate_fasta_format as validate_fasta_content, read_fasta, write_fasta
from protos.io.utils.file_utils import get_filenames
from protos.io.ingest.utils.uniprot_utils import *
...
class UniprotDL:
    ...
    def __init__(self,
        ...
        self.fasta_dir = self.paths.get_subdir_path('sequence', 'dataset_fasta_dir')
