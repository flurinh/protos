...
# from protos.io.utils.data_access import generate_entity_id
...
class GRNProcessor(BaseProcessor):
    ...
    Handles loading, saving, and analysis of GRN tables which map
    ...
    def load_grn_table(self, dataset_id=None, low_memory=False, remove_duplicates=True,
        ...
        if register_entities and 'entity_id' not in current_df.columns:
            try:
                global_registry = None # GlobalRegistry()
                
                # Register each sequence as an entity
                for seq_id in self.ids:
                    entity_id = None # generate_entity_id(str(seq_id))
        ...
        if normalize_formats:
            ...
            for col in original_columns:
                ...
                try:
                    ...
                    self.logger.error(f"Error analysis column {col}: {e}")
        ...
        for col in original_columns:
            ...
            if 'x' in col:
                ...
                try:
                    ...
                    self.logger.error(f"Error analysis dot notation {col}: {e}")
    ...
    def save_temp_table(self, temp_name: str, temp_data: pd.DataFrame) -> Path:
        ...
        analysis and can be automatically cleaned up.
    ...
    def load_grn_entity(self, identifier: str) -> Optional[pd.Series]:
        ...
        try:
            ...
            original_id = identifier
            entity_id = None # generate_entity_id(identifier)
